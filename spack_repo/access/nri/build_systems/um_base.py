...
class UmBasePackage(Package):
    ...
    for var in _off_on_variants:
        variant(var, default="rose_default", sticky=True, description=var,
            values=("rose_default", "off", "on"), multi=False)

    # String variants have their default values set to "rose_default" here.
    ...
    for _project in _projects:
        ...
        variant(_ref_var, default="rose_default", sticky=True, values="*", multi=False,
    ...
    def setup_build_environment(self, env):
        ...
        def check_model_vs_project(
            ...
            else:  # sources_value != "rose_default"
        ...
        def check_model_vs_root_path_vs_um_ref(
            ...
            if root_path_value == "rose_default":
            ...
            else:  # root_path_value != "rose_default"
