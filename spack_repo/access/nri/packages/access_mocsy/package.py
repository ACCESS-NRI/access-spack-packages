...
class AccessMocsy(CMakePackage, MakefilePackage):
    ...
    # Depending on cmake should not be needed, but it is a workaround
    # to the concretization issue when building with gcc.
    # i.e. It avoids the following concretization:
