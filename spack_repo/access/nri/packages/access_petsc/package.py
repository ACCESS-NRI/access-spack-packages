...
class AccessPetsc(Package, CudaPackage, ROCmPackage):
    ...
    depends_on("access-mumps+mpi~int64~metis~parmetis~openmp", when="+mumps~metis~openmp")
    depends_on("access-mumps+mpi~int64+metis+parmetis~openmp", when="+mumps+metis~openmp")
    depends_on("access-mumps+mpi~int64~metis~parmetis+openmp", when="+mumps~metis+openmp")
    depends_on("access-mumps+mpi~int64+metis+parmetis+openmp", when="+mumps+metis+openmp")
